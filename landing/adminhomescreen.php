...
<?php   } ?> 
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="d-block  "  style="width:90%;height:250px;margin-left:5%;margin-right:5%" src="classic.png" alt="Third slide">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                            ...
                            <div class="wp-block-button btn-lg is-style-fill"><a class="wp-block-button__link" href="tamilmovies.php" style="border-radius:8px;padding: 0px;" rel="noreferrer noopener">
