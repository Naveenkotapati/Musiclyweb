...
#project-title {
    ...
    margin-top: 60px;
    /* text-shadow: 3px 3px 7px rgba(13,110,253,.25); */
}
          ...
          <div  class="container w-100">
            <div class="col-12">
                <div class="row">
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                 <div class="col-md-12 text-center col-lg-6" style="display:flex;">
...
<div id="goback-link">
    ...
    <a href="http://localhost/music/landing/allmovies.php">&#8592;</a>
        ...
        <div  class="container w-100">
            <div class="col-12">
                <div class="row" >
                <div class=" col-xs-12" style="margin-bottom:50px;display:flex;">
                        <!-- <div  class="col-md-12 col-lg-6 text-center">
                        
                            <img src="http://localhost/music/landing/musicplayer/images/headphones.png" alt="" id="display-img" class="img-fluid border bg-gradient   ">
                       
                        </div> -->
                        <div class="col-md-12 col-lg-6 text-center">
    <img src="http://localhost/music/landing/musicplayer/images/headphones.png" alt="" id="display-img" class="img-fluid border bg-gradient rounded-circle" style="width: 200px; height: 200px;">
</div>
    ...
    margin-left: -190px;>
                        <h4><b id=; margin-top: 77px;"inplay-title"></b></h4>
                        <p id="inplay-description" style="color:#000"></p>
                        <small class="text-muted" style="color:#000;" id="inplay-duration"></small>
