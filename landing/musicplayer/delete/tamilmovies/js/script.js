...
function displayImg(input, displayTo) {
    if (input.files && input.files[0]) {
        ...
        $('#' + displayTo).attr('src', "http://localhost/music/landing/musicplayer/images/music-logo.jpg");
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp.status == 'success') {
                    ...
                    data.audio_path = (data.audio_path).replace("http://localhost/music/landing/musicplayer/images/audio/", "");
                    ...
                    _modal.find('#status').val(data.status)
                    _modal.modal('show')
                } else {
                    console.error(err)
                    alert("An error occurred");
