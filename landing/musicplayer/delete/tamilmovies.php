...
$sql = "SELECT * FROM music_list1 where language='tamil'";
     ...
     {?> 
                                    ...
                                    <div class="enquiry__list ml-10 mr-10 ms-browse-act-wrap p-relative">
                                        <div class="ms-enquiry-box p-relative d-none d-xl-inline-flex">
                                            ...
                                            <?php?> 
                                            <li>
                                            <a href="http://localhost/music/landing/contact.php"><i class="flaticon-star icon">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms-popular__item p-relative mb-30">
                                                    <div class="ms-popular__thumb">
                                                        ...
                                                        <img src="http://localhost/music/landing/musicplayer/images/<?=$rows['image_path']?>">
                                                    ...
                                                    <a href="http://localhost/music/landing/musicplayer/tamilmovies/index.php?title=<?php echo $title;?>">
