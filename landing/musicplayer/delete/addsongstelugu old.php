...
<body class="text-light bg-dark bg-gradient">
    ...
    <main>
        ...
        <div class="col-lg-12">
            <h1 class="fw-bolder text-center" id="project-title"> Add New Movie Songs </a></h1>
        </div> 

        <div align ="center">
                            <a href="http://localhost/music/landing/telugumovies.php">Go Back</a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="card rounded-0 shadow">
                        ...
                        <div class="card-body">
                            <ul class="list-group" id="music-list">
                                <?php 
                                $music = $conn->query("SELECT * FROM music_list where language='telugu'");
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="col-md-12 text-center">
                            <img src="./images/musicplayer.jpg" alt="" id="display-img" class="img-fluid border bg-gradient bg-dark">
                        </div>
