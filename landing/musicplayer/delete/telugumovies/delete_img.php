...
if($query->num_rows > 0){
    ...
    if($delete){
        ...
        echo '<script>alert("Audio Data successfully deleted."); location.replace("http://localhost/music/landing/musicplayer/telugumovies/index.php?title='. $res['title'] . ' ")</script>';
    }else{
