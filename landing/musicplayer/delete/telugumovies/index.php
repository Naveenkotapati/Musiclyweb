...
<?php if( $_SESSION['role']=='admin')
     ...
     <main>
                 ...
                 <div class="col-lg-12">
                                    ...
                                    <div align ="center">
                                                        <a href="http://localhost/music/landing/musicplayer/telugumovies.php">Go Back</a>
                                                        </div>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="" id="update-music-form">
                            ...
                            $query = $conn->query("SELECT * FROM music_list");
                            ...
                            <?php if($row['status']=='No') { ?>
                                    ...
                                    <div class="form-group">
                                        <label for="status">Recommendation</label>
                                        <input type="radio" name="status" id="c03" value="Yes"/>Yes
                                        <input type="radio" name="status" id="c04" value="No" checked />No
                                    </div>
                                    <?php  }else { ?>

                                        <div class="form-group">
                                        <label for="status">Recommendation</label>
                                        <input type="radio" name="status" id="c03" value="Yes" checked/>Yes
                                        <input type="radio" name="status" id="c04" value="No" />No
                                    </div>
                            <?php }} ?>     -->
