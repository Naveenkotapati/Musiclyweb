...
<?php if( $_SESSION['role']=='admin')
     ...
     <main>
                 ...
                 <div class="col-lg-12">
                                    ...
                                    <div align ="center">
                                                        <a href="http://localhost/music/landing/musicplayer/englishmovies.php">Go Back</a>
                                                        </div>
                    ...
                    <div class="container-fluid">
                        <form action="" id="music-form">
                            ...
                            <!-- <div class="form-group mb-3">
                                ...
                                <input type="hidden" name="id" id="id" class="form-control form-control-sm rounded-0"  value="<?php echo $id;?>">
                            </div> -->
                            <div class="form-group mb-3">
