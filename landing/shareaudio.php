...
//     $folder = "./music/" . $testaudio3;
	...
	$sql = "INSERT INTO page_link (audio_title, audio_description, pagelink, userid, username, status) VALUES ('$audiotitle','$description','$link','$id','$name','Wait For Approval')";
...
<body>
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Audio Title" name="audio_title" required>
    

    <input type="text" placeholder="Enter Audio Description" name="audio_description" required>

	
    <hr>

	<input type="text" placeholder="Enter your Shared Page Link " name="pagelink" required>
