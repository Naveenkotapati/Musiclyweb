...
var x = document.getElementById("language").selectedOptions[0].label;
  ...
  if(x == "Select Language"){
    ...
    #goback-link:hover {
        ...
        <div class="col-lg-12">
            <h1 class="fw-bolder text-center" id="project-title"> Add New Concert </a></h1>
        </div> 
                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header py-1">
                            <div class="d-flex w-100">
                                <h5 class="card-title col-auto flex-grow-1 flex-shrink-1">Concert</h5>
                                <div class="col-auto">
                            ...
                            <ul class="list-group" id="music-list">
                                ...
                                <li class="list-group-item list-group-item-action item">
                                    <div class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-auto flex-grow-1 flex-shrink-1">
                                        <p class="m-0 text-truncate" >Action</p>
                                        </div>
  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody id="music-list">
      <?php
      $music = $conn->query("SELECT * FROM concert");
      while ($row = $music->fetch_assoc()):
      ?>
      <tr>
        <td>
          <img src="<?= is_file(explode("?", $row['image_path'])[0]) ? $row['image_path'] : "./images/music-logo.jpg" ?>" alt="<?= $row['title'] ?>" class="img-thumbnail img-fluid" style="width: 100px; height: 80px; object-fit: cover;">
        </td>
        <td><?= $row['title'] ?></td>
      ...
      <?php endwhile; ?>
                        ...
                        <!-- <div class="card-body">
                            <ul class="list-group" id="music-list">
                                <?php 
                                //$music = $conn->query("SELECT * FROM concert where language='tamil'");
                                $music = $conn->query("SELECT * FROM concert");
        ...
        <div class="modal text-dark" id="music_modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-md">
                ...
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fa fa-music"></i> Add New Concert</h5>
        ...
        <div class="modal text-dark" id="update_music_modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content rounded-0">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fa fa-music"></i> Update Concert Data</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="" id="update-music-form">
                            <input type="hidden" name="id" >
                            <div class="form-group mb-3">
                                <label for="title2" class="control-label">Concert Name</label>
