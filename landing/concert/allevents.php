...
var x = document.getElementById("language").selectedOptions[0].label;
  ...
  if(x == "Select Language"){
    ...
    #goback-link:hover {
        ...
        <div class="col-lg-12">
            <h1 class="fw-bolder text-center" id="project-title"> All Language Concert </a></h1>
        </div> 
                            ...
                            <ul class="list-group" id="music-list">
                                ...
                                <li class="list-group-item list-group-item-action item">
                                    <div class="d-flex w-100 align-items-center">
                                        ...
                                        <p class="m-0 text-truncate" style="width:100%">Name</p>
                                        </div>
                                        <div class="col-auto flex-grow-1 flex-shrink-1">
                                        <p class="m-0 text-truncate"  style="width:100%">Description</p>
                                        </div>
                                        <div class="col-auto flex-grow-1 flex-shrink-1">
                                        <p class="m-0 text-truncate" style="width:100%" >Date</p>
                                        </div>
                                        <div class="col-auto flex-grow-1 flex-shrink-1">
                                        <p class="m-0 text-truncate" style="width:100%" >Time</p>
                                        </div>
                                        <div class="col-auto flex-grow-1 flex-shrink-1">
                                        <p class="m-0 text-truncate"  style="width:100%">Place</p>
                                        </div>
                                        <div class="col-auto flex-grow-1 flex-shrink-1">
                                        <p class="m-0 text-truncate"  style="width:100%">Language</p>
                                        </div>
