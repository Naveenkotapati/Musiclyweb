...
$sql = "SELECT * FROM music_list1 where language='telugu'";
                        ...
                        ?>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms-popular__item p-relative mb-30">
                                                    ...
                                                    <a href="http://localhost/music/landing/musicplayer/telugumovies/index.php?title=<?php echo $title;?>">
            ...
            <section class="ms-song-area pt-40 pb-40">
                <div class="container-fluid ms-maw-1710">
                        <div class="col-xl-6 col-lg-6">
                           <span class="section__subtitle">Recommendation</span>
                        </div>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                                ...
                                                <div class="ms-song-content">
                                                    <h3 class="ms-song-title"><a href="http://localhost/music/landing/musicplayer/telugumovies/index.php?title=<?php echo $title;?>"><?php  echo $rows['title'];?></a>
                                                    </h3>
                                                    <span class="ms-song-text"><?php  echo $rows['description'];?></a></span>
                                                </div>
